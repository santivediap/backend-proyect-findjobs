...
const getUserByEmail = async (email) => {
  // el email hay que cogerlo desde el token de usuario y codificarlo en una función que está en el middleware de la demo de tokens y autenticación.
  let client, result;
  try {
...
const createUser = async (user_data) => {
  // user_data es por donde llega el objeto queries de queries
